    ...
    <body>
        ...
        <div class="col-sm-8" style="align-content: center;">
            <table class="table table-hover" >
                <tr>
                    <td width="100%">
                        <form mehod="post" action="Modificar.jsp">
                            <h2>
                                Ingresa el nombre del producto a modificar y después los nuevos atributos
                            </h2>
                            <table  width="100%">
                                <tr>
                                    <td width="50%">
                                ...
                                <tr>
                                    ...
                                    <td >
                                        <input type="text" name="stock_prod" min="1" max="999" required>
                                    </td> 
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td width="50%">
                                        <input type="text" name="precio_prod" min="1" max="100000" required>
                                    </td> 
                                </tr>
                                <td width="50%">
                                    <input class="btn btn-outline-success" type="submit" value="Modificar item">
                                </td>
                                <td width="50%">
